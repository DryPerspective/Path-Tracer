...
bool Lambertian::isScattered(const Ray& inRay, const HitRecord& inRecord, Physics::PhysicsVector<3>& inColourAtten, Ray& scatteredRay) const {
	...
	auto scatterDirection{ inRecord.m_normal + Physics::randLambertianUnitSphere() };
