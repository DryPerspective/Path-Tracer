...
bool Metal::isScattered(const Ray& inRay, const HitRecord& inRecord, Physics::PhysicsVector<3>& inColourAtten, Ray& scatteredRay) const {
	...
	scatteredRay = Ray(inRecord.m_point, reflectedDirection + Physics::randInUnitSphere().scaledBy(m_fuzz));
